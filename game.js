...
(function() {
    ...
    var loadPackage = function(metadata) {
        ...
        if (
            ...
            Module['locateFile'] =
                Module['locateFilePackage'];

            Module.printErr(
                'warning: you defined Module.locateFilePackage, ' +
                'which has been renamed to Module.locateFile'
            );
        }
        ...
        function fetchRemotePackage(
            ...
            xhr.onprogress = function(event) {
                ...
                if (event.loaded) {
                    ...
                    for (
                        var download in Module.dataFileDownloads
                    ) {

                        var data =
                            Module.dataFileDownloads[download];
        ...
        function runWithFS() {
            ...
            function cacheRemotePackage(
                ...
                var packages =
                    transaction_packages.objectStore(
                        PACKAGE_STORE_NAME
                    );


                var putPackageRequest =
                    packages.put(
                        packageData,
                        "package/" +
                        packageName
            ...
            function processPackageData(
                ...
                if (Module['SPLIT_MEMORY']) {
                    ...
                    Module.printErr(
                        'warning: you should run the file packager with --no-heap-copy when SPLIT_MEMORY is used'
                    );
                }
    ...
    loadPackage({
        ...
        "remote_package_size": 57409813,

        "package_uuid":
            "c7349745-8ee1-443f-bfbc-0243a7b45d93"
    });
 ...
 *
 * The generated loader defines applicationLoad,
 * but your wrapper wasn't invoking it.
 */
applicationLoad();
